'use client';
// =============================================
// ExploreClient - Content browsing with filters
// =============================================
...
export const ExploreClient = () => {
    ...
    const { data, isLoading, isError, isFetching } = useQuery({
        queryKey: ['public-content', { search: debouncedSearch, type, difficulty, categoryId, sortBy, page, limit }],
        queryFn: () =>
    ...
    const activeFilterCount = [type, difficulty, categoryId].filter(Boolean).length;
    ...
    useEffect(() => {
        setPage(1);
    }, [debouncedSearch, type, difficulty, categoryId, sortBy]);
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-muted-foreground">
                    Discover articles, tutorials, projects, and more
                </p>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        ...
                        <Select
                            value={type ?? 'all'}
                            onValueChange={(value) => setType(value === 'all' ? undefined : (value as ContentType))}
                        >
